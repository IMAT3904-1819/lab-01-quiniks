...
public:
	static Random * instance();	//!< Returns a pointer to the static texture loader
								...
								*/
	float getRandFloat(float p_Min, float p_Max); //!< Returns a random real number inclusive of min and max
	int getRandInt(int p_Min, int p_Max); //!< Returns a random integer inclusive of min and max
